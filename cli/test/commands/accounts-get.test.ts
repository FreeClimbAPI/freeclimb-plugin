...
describe("accounts:get Data Test", function () {
    const testJson = {
  ...
  "message": "Response from server"
    ...
    it("Test parse error gets triggered when there is an additional argument", async () => {
        const { error } = await runCommand(["accounts:get", "additionalArguments"])
    ...
    describe("accounts:get next flag test", function () {
        afterEach(() => {
            nock.cleanAll()
        })
...
describe("accounts:get Status Test", function () {
