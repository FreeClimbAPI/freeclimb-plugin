  ...
  "message": "Response from server"
    ...
    it("Test all required paramaters", async () => {
        nock("https://www.freeclimb.com")
            ...
            .query({})
            .reply(200, testJson)
        const { stdout } = await runCommand(["calls:list-call-logs", "userInput-callId"])
    ...
    describe("calls:list-call-logs next flag test", function () {
        ...
        before(async () => {
            ...
            testJsonNext2.nextPageUri = `https://www.freeclimb.com/apiserver/Accounts/${accountId}/Calls/${callId}/Logs?cursor=freeClimbCLIAutomatedTestCursor`
        })
        ...
        it("Tests return of Exit Code 3 when flag next is not available", async () => {
            ...
            try {
                ...
                if (orig === undefined)
                    {delete process.env.FREECLIMB_CALLS_LIST_CALL_LOGS_NEXT}
                else {process.env.FREECLIMB_CALLS_LIST_CALL_LOGS_NEXT = orig}
            }
        })
