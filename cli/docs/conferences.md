...
FLAGS
  ...
  -b, --playBeep=<value>           Controls when a beep is played. Valid values: always, never, entryOnly, exitOnly.
  -h, --help                       Show CLI help.
  -r, --record=<option>            Setting to true records the entire Conference.
                                   <options: true|false>
  -s, --statusCallbackUrl=<value>  This URL is invoked when the status of the Conference changes.
  -w, --waitUrl=<value>            If specified, a URL for the audio file that provides custom hold music for the
                                   Conference when it is in the populated state. Otherwise, FreeClimb uses a system
                                   default audio file. This is always fetched using HTTP GET and is fetched just once -
...
_See code: [src/commands/conferences/create.ts](https://github.com/FreeClimbAPI/freeclimb-plugin/blob/v0.6.0/src/commands/conferences/create.ts)_
...
_See code: [src/commands/conferences/get.ts](https://github.com/FreeClimbAPI/freeclimb-plugin/blob/v0.6.0/src/commands/conferences/get.ts)_
...
FLAGS
  ...
  -S, --status=<value>       Only show conferences that currently have the specified status. Valid values: empty,
                             populated, inProgress, or terminated.
  -a, --alias=<value>        List Conferences whose alias exactly matches this string.
  -d, --dateCreated=<value>  Only show Conferences that were created on the specified date, in the form YYYY-MM-DD.
  -h, --help                 Show CLI help.
...
_See code: [src/commands/conferences/list.ts](https://github.com/FreeClimbAPI/freeclimb-plugin/blob/v0.6.0/src/commands/conferences/list.ts)_
...
FLAGS
  ...
  -a, --alias=<value>     Description for this conference. Maximum 64 characters.
  -b, --playBeep=<value>  Controls when a beep is played. Valid values: always, never, entryOnly, exitOnly.
  -h, --help              Show CLI help.
      --dry-run           Validate the request without executing it. Shows what would be sent to the API.
      --fields=<value>    Comma-separated list of fields to include in the response. Limits output to protect context
...
_See code: [src/commands/conferences/update.ts](https://github.com/FreeClimbAPI/freeclimb-plugin/blob/v0.6.0/src/commands/conferences/update.ts)_
