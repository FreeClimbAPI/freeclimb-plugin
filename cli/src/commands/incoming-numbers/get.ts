...
export class incomingNumbersGet extends Command {
    ...
    async run() {
        ...
        const { args, flags } = await this.parse(incomingNumbersGet)
        ...
        const formatOutput = (data: any) => {
            ...
            out.render(outputData, { topic: "incoming-numbers", command: "get" })
            return null
        }
        const normalResponse = (response: FreeClimbResponse) => {
            if (response.status === 204) {
                ...
                if (outputFormat === "json") {
                    ...
                    out.render(null, { topic: "incoming-numbers", command: "get" })
                }
