...
export class conferenceParticipantsGet extends Command {
    ...
    async run() {
        ...
        const { args, flags } = await this.parse(conferenceParticipantsGet)
        ...
        const formatOutput = (data: any) => {
            ...
            out.render(outputData, { topic: "conference-participants", command: "get" })
            return null
        }
            ...
            if (response.status === 204) {
                ...
                if (outputFormat === "json") {
                    out.out(
                        JSON.stringify(
                            wrapJsonOutput(null, {
                                command: "conference-participants:get",
                                request: {
                                    method: "GET",
                    ...
                    out.render(null, { topic: "conference-participants", command: "get" })
                }
