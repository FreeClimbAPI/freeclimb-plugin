...
export class callQueuesGet extends Command {
    ...
    async run() {
        ...
        const { args, flags } = await this.parse(callQueuesGet)
        ...
        const formatOutput = (data: any) => {
            ...
            out.render(outputData, { topic: "call-queues", command: "get" })
            return null
        }
            ...
            if (response.status === 204) {
                ...
                if (outputFormat === "json") {
                    out.out(
                        JSON.stringify(
                            wrapJsonOutput(null, {
                                command: "call-queues:get",
                                request: { method: "GET", endpoint: `Queues/${args.queueId}` },
                            }),
                            null,
                            2,
                        ),
                    ...
                    out.render(null, { topic: "call-queues", command: "get" })
                }
